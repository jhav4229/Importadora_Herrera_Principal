...
<html lang="en">
  <head>
    ...
    <title>.: Importadora Herrera :.</title>
    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="./">Importadora Herrera<sup><small><span class="label label-primary">UPS</span></small></sup> </a>
        </div>
...
?>
         <ul class="nav navbar-nav">
		  ...
		  <li><a href="index.php?view=metricas"><i class="fa fa-area-chart"></i> Metricas</a></li>
