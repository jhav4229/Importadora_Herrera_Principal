...
<input type="hidden" class="form-control"  name="paymethod_id" value="<?php echo $_POST["paymethod_id"];?>">
<button class="btn btn-primary btn-block">Proceder a Comprar</button>
</form>
<?php endif; ?>
<br>
	<script type="text/javascript">
				function guardar_historial_cancelar()
				{
					 var cliente_log = $("#usuario_logueado").val();
						$.ajax({
							...
							data:{codcliente:cliente_log,operacion_tipo:4},
							dataType: "json",
...
<br><a href="index.php?action=cleancart" class="btn btn-danger btn-block" onclick="guardar_historial_cancelar()">Cancelar</a>
</div>
</div>
