...
<?php if($buy->status_id==1):?>
	<script type="text/javascript">
				function guardar_historial_cancelar_final()
				{
...
<input type="submit" class="btn btn-danger btn-block" value="Cancelar Compra" onclick="guardar_historial_cancelar_final()">
